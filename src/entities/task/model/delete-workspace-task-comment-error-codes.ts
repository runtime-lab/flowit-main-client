export const DELETE_WORKSPACE_TASK_COMMENT_ERROR_CODES = {
...
export type DeleteWorkspaceTaskCommentErrorCode = keyof typeof DELETE_WORKSPACE_TASK_COMMENT_ERROR_CODES;

export function isDeleteWorkspaceTaskCommentErrorCode(code: string): code is DeleteWorkspaceTaskCommentErrorCode {
    return code in DELETE_WORKSPACE_TASK_COMMENT_ERROR_CODES;
}

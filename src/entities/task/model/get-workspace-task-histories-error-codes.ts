export const GET_WORKSPACE_TASK_HISTORIES_ERROR_CODES = {
...
export type GetWorkspaceTaskHistoriesErrorCode = keyof typeof GET_WORKSPACE_TASK_HISTORIES_ERROR_CODES;

export function isGetWorkspaceTaskHistoriesErrorCode(code: string): code is GetWorkspaceTaskHistoriesErrorCode {
    return code in GET_WORKSPACE_TASK_HISTORIES_ERROR_CODES;
}

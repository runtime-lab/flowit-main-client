export const UPDATE_WORKSPACE_TASK_PROGRESS_ERROR_CODES = {
...
export type UpdateWorkspaceTaskProgressErrorCode = keyof typeof UPDATE_WORKSPACE_TASK_PROGRESS_ERROR_CODES;

export function isUpdateWorkspaceTaskProgressErrorCode(code: string): code is UpdateWorkspaceTaskProgressErrorCode {
    return code in UPDATE_WORKSPACE_TASK_PROGRESS_ERROR_CODES;
}
